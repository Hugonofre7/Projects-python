"""Vigen̬re Cipher, by Al Sweigart al@inventwithpython.com
The Vigen̬re cipher is a polyalphabetic substitution cipher that was
...
def main():
    print('''Vigen̬re Cipher, by Al Sweigart al@inventwithpython.com
The Viegen̬re cipher is a polyalphabetic substitution cipher that was
powerful enough to remain unbroken for centuries.''')
