...
Translate English messages into Igpay Atinlay.
...
By Al Sweigart @inventwithpython

Enter your message:''')
    pigLatin = englisdToPigLatin(input('> '))
...
def englisdToPigLatin(message):
    ...
    for word in message.split():
        ...
        # Remember if the word was in uppercase, titlecase.
