    ...
    for y in range(HEIGHT):
        for x in range(WIDTH):
            if (x, y) == (playerx, playery):
                ...
                print(maze[(x, y)], end='')
        print() #Print a newline after print the narow.


print('''Maze Runner 2D, by Al Sweigart al@inventwithpython.com
(Maze files are generates by mazemakerrec.py)''')
...
assert exitx != None and exit != None, 'No exit in maze file.'

while True:  #Main game loop.
    displayMaze(maze)
    
    while True:  # Get user momve.
        print('                           W')
        ...
        #Check if the player can move in that direccion:
    ...
    if move == 'W':
        while True:
            ...
            if (maze[(playerx -1, playery)] == EMPTY or maze[(playerx +1, playery)] == EMPTY):
                break  #Break ir we've reached a branch point.
    elif move == 'S':
        while True:
            playery += 1
            if (playerx, playery) == (exitx, exity):
